...
var resizePizzas = function(size) { 
  ...
  function changePizzaSizes(size) {
    ...
    var newwidth;
    var PizzaChange = document.querySelectorAll(".randomPizzaContainer");
    for (i, len=PizzaChange.length; i < len; i++) {
      newwidth = (PizzaChange[i].offsetWidth + dx) + 'px';
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  for (var i = 0; i < screen.height/s; i++) {
